...
var _user$project$Child_Update$cKEditor = _elm_lang$core$Native_Platform.outgoingPort(
	'cKEditor',
	function (v) {
		return v;
	});
var _user$project$Child_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Noop') {
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Child_Update$cKEditor(_p0._0)
			};
		}
	});
var _user$project$Child_Update$Selected = function (a) {
	return {ctor: 'Selected', _0: a};
};
var _user$project$Child_Update$Noop = {ctor: 'Noop'};

var _user$project$Parent_Update$ChildMessages = function (a) {
	return {ctor: 'ChildMessages', _0: a};
};
var _user$project$Parent_Update$delegateToChild = F2(
	function (msg, model) {
		var _p0 = A2(_user$project$Child_Update$update, msg, model.child);
		var child = _p0._0;
		var cmd = _p0._1;
		var model$ = _elm_lang$core$Native_Utils.update(
			model,
			{child: child});
		var cmd$ = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Parent_Update$ChildMessages, cmd);
		return {ctor: '_Tuple2', _0: model$, _1: cmd$};
	});
var _user$project$Parent_Update$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'Noop') {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			return A2(_user$project$Parent_Update$delegateToChild, _p1._0, model);
		}
	});
var _user$project$Parent_Update$Noop = {ctor: 'Noop'};

var _user$project$App_Update$init = function () {
	var child = _user$project$Child_Model$Model('hello world');
	var parent = _user$project$Parent_Model$Model(child);
	return {ctor: '_Tuple2', _0: parent, _1: _elm_lang$core$Platform_Cmd$none};
}();
var _user$project$App_Update$update = _user$project$Parent_Update$update;
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Child_Update$Selected(model.value))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Parent_Update$ChildMessages,
				_user$project$Child_View$view(model.child))
			]));
};
